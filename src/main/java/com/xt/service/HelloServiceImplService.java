 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://Impl.service.xt.com/", wsdlLocation = "http://localhost:9999/javaws/getHello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/javaws/getHello?wsdl");
